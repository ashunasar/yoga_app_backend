                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" name="vid_dur" class="form-control" required>
                        </div>
                      </div>
                    </div>
...
$query = "INSERT INTO `yoga_details` (`yoga_details_id`, `yoga_name`, `instructions`, `objective`, `video_path`,`video_duration`, `thumbnail_path`) VALUES (NULL, :yoga_name, :instructions,:objective, :video_path,:video_duration, :thumbnail_path)";
...
//    $reslut->execute(['yoga_name'=>$yoga_name,'instructions'=>$yoga_ins,'objective'=>$yoga_obj,'video_path'=>$vid_url,'thumbnail_path'=>"img/$img_name"]);
    $reslut->execute(['yoga_name'=>$yoga_name,'instructions'=>$yoga_ins,'objective'=>$yoga_obj,'video_path'=>$vid_url,'video_duration'=>$vid_dur,'thumbnail_path'=>$img_url]);
