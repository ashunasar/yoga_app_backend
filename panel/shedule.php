...
<!--                  <p class="card-category"> Here is a subtitle for this table</p>-->
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <?php
                    $query = 'SELECT yoga_details_id,yoga_name,day FROM `yoga_details`';
...
-->
                ...
                $date =  $_POST['date'];
                $exp_data = explode(',',$Id_data);
//               UPDATE user SET day = concat(day , ?,',')
                count($exp_data)-1; echo "<br>";
                for($i=0;$i<count($exp_data)-1;$i++){
                $query = "UPDATE yoga_details set day = concat(day , ?,',') WHERE yoga_details_id=?";
                $result = $con->prepare($query);
                $result->execute([$date,$exp_data[$i]]);
                }
